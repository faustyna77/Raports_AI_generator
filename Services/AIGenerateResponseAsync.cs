...
namespace AI_Raports_Generators.Services
{
    public class AIResponseGeneratorService : IAIResponseGeneratorService
    {
        ...
        {
            var promptText = $"Jesteś agentem do tworzenia dokumentów. " +
                             $"Napisz oficjalne pismo typu '{documentType}' skierowane do '{nameOfCompany}'. " +
                             $"Szczegóły sprawy: {description}. Styl: formalny, jasny, urzędowy. " +
                             $"Treści wygenerowane przez ciebie będą oficjalnie w PDF-ach, " +
                             $"nie dodawaj pytań ani sugestii na końcu ani na początku.";
